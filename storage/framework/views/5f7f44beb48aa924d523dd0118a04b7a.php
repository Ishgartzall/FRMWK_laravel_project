    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <img class="h-12 w-8" src="<?php echo e(asset('img/logo_horde_noir.png')); ?>" alt="logo">
          </div>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3" >
              <div>
                <button type="button" @click="isOpen=!isOpen" class="relative flex max-w-xs items-center rounded-full bg-red-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-red-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  <span class="absolute -inset-1.5"></span>
                  <span class="sr-only">Open user menu</span>
                  <img class="h-8 w-8 rounded-full" src="<?php echo e(asset('img/rond_profil.jpg')); ?>" alt="">
                </button>
              </div>
              ...
              class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <a href="#" class="block px-4 py-2 text-sm text-red-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                <a href="#" class="block px-4 py-2 text-sm text-red-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</a>
                <a href="#" class="block px-4 py-2 text-sm text-red-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</a>
              </div>
            </div>
          </div>
        </div>
...
<?php endif; ?>
      ...
      <div class="border-t border-red-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="<?php echo e(asset('img/rond_profil.jpg')); ?>" alt="">
          </div>
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Victor Lequeux</div>
            <div class="text-sm font-medium leading-none text-red-400">victor.lequeux@etu.imt-nord-europe.fr</div>
          </div>
        </div>
        <div class="mt-3 space-y-1 px-2">
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-red-400 hover:bg-red-700 hover:text-white">Your Profile</a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-red-400 hover:bg-red-700 hover:text-white">Settings</a>
          <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-red-400 hover:bg-red-700 hover:text-white">Sign out</a>
        </div>
      </div>
    </div>
  </nav><?php /**PATH C:\xampp\htdocs\framework_prog_class_test\resources\views/components/navbar.blade.php ENDPATH**/ ?>